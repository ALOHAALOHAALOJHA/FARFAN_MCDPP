...
def test_contract_02_artifacts_dir_must_be_created():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch(
            "farfan_pipeline.phases.Phase_00.verified_pipeline_runner.RuntimeConfig"
        ) as mock_config:
...
def test_contract_08_prod_mode_must_fail_on_boot_check_error():
    ...
    with patch(
        "farfan_pipeline.phases.Phase_00.phase0_50_00_boot_checks._check_calibration_files"
    ) as mock_check:
...
def test_contract_09_dev_mode_must_warn_on_boot_check_failure():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch(
            ...
            with patch(
                "farfan_pipeline.phases.Phase_00.verified_pipeline_runner.run_boot_checks"
            ) as mock_boot:
