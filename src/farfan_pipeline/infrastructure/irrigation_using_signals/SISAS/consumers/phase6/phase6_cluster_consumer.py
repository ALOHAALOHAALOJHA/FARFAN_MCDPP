"""
Phase6 Cluster Consumer - PHASE6

Cluster aggregation consumer for Phase 6

Generated by IrrigationProtocol v1.0.0
Date: 2026-01-19T19:16:01.108657
"""
...
class Phase6ClusterConsumerConfig:
    ...
    def __post_init__(self):
        if not self.enabled_signal_types:
            self.enabled_signal_types = ['CLUSTER_AGGREGATION', 'CL01_SCORE', 'CL02_SCORE', 'CL03_SCORE', 'CL04_SCORE']
...
class Phase6ClusterConsumer(BaseConsumer):
    ...
    This consumer handles signal irrigation for phase6.
    ...
    def __init__(self, config: Phase6ClusterConsumerConfig = None):
        ...
        self.consumer_id = "phase6_phase6_cluster_consumer"
