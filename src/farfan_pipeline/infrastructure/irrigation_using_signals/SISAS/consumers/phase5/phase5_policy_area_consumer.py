"""
Phase5 Policy Area Consumer - PHASE5

Policy area aggregation consumer for Phase 5

Generated by IrrigationProtocol v1.0.0
Date: 2026-01-19T19:16:01.108430
"""
...
@dataclass
class Phase5PolicyAreaConsumerConfig:
    """Configuration for Phase5PolicyAreaConsumer."""
    ...
    def __post_init__(self):
        if not self.enabled_signal_types:
            self.enabled_signal_types = ['POLICY_AREA_AGGREGATION', 'PA01_SCORE', 'PA02_SCORE', 'PA03_SCORE', 'PA04_SCORE', 'PA05_SCORE', 'PA06_SCORE', 'PA07_SCORE', 'PA08_SCORE', 'PA09_SCORE', 'PA10_SCORE']


class Phase5PolicyAreaConsumer(BaseConsumer):
    """
    Policy area aggregation consumer for Phase 5

    This consumer handles signal irrigation for phase5.

    Signal Types:
        - POLICY_AREA_AGGREGATION\n    - PA01_SCORE\n    - PA02_SCORE\n    - PA03_SCORE\n    - PA04_SCORE\n    - PA05_SCORE\n    - PA06_SCORE\n    - PA07_SCORE\n    - PA08_SCORE\n    - PA09_SCORE\n    - PA10_SCORE
    """

    def __init__(self, config: Phase5PolicyAreaConsumerConfig = None):
        """
        Initialize Phase5PolicyAreaConsumer.

        Args:
            config: Configuration for this consumer
        """
        self.config = config or Phase5PolicyAreaConsumerConfig()
        self.consumer_id = "phase5_phase5_policy_area_consumer"
