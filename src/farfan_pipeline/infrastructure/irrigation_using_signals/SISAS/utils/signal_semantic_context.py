...
class SemanticContext:
    ...
    def disambiguate_pattern(self, pattern: str, context: str | None = None) -> str:
...
def extract_semantic_context(semantic_layers: dict[str, Any]) -> SemanticContext:
...
def apply_semantic_disambiguation(
    patterns: list[str], semantic_context: SemanticContext, document_context: str | None = None
) -> list[str]:
    ...
    for pattern in patterns:
        disambiguated_pattern = semantic_context.disambiguate_pattern(pattern, document_context)
        disambiguated.append(disambiguated_pattern)

    return disambiguated


def get_entity_linking_config(semantic_context: SemanticContext) -> dict[str, Any]:
