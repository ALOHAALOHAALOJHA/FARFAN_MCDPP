...
---------------------------
Following Derek Beach's process-tracing methodology, we distinguish between:

1. ANALYTICAL DIMENSIONS: Epistemological lenses for evidence extraction
2. CAUSAL MECHANISMS: Real-world entities that transmit causal forces
3. HEURISTIC CHAINS: Simplified representations (e.g., logic models)

Our dimensions are NOT links in a chain but orthogonal analytical operations
that extract different types of evidence about underlying causal mechanisms.

The CAUSALIDAD dimension is special: it captures explicit mechanistic claims
about HOW and WHY interventions produce outcomes (not just that they do).

Author: F.A.R.F.A.N Core Team
Created: 2026-01-16
Updated: 2026-01-21
Version: 3.0.0-mechanistic
"""
...
# ============================================================================
# TYPE ALIASES - Empirical Evidence Categories
# ============================================================================

#: Types of process-tracing tests (Beach & Pedersen, 2013)
ProcessTracingTestType = Literal[
    "hoop",           # Necessary but not sufficient
    "smoking_gun",    # Sufficient but not necessary
    "doubly_decisive", # Necessary AND sufficient
    "straw_in_wind"   # Neither necessary nor sufficient
]

#: Evidence diagnostic power levels
DiagnosticPowerType = Literal["low", "moderate", "high", "decisive"]

#: Mechanism component types
MechanismPartType = Literal["entity", "activity", "observable_implication"]
...
class DimensionAnalitica(IntEnum):
    ...
    @property
    def process_tracing_test(self) -> str:
