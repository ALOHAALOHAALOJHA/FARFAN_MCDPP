...
PDET_MUNICIPALITIES: list[PDETMunicipality] = [
    ...
    PDETMunicipality(
        "Argelia", "Cauca", PDETSubregion.ALTO_PATIA, 31000, 661.0, "19050", 2.263, -77.194
    ),
    ...
    PDETMunicipality(
        "Santander de Quilichao", "Cauca", PDETSubregion.ALTO_PATIA, 95000, 543.0, "19693"
    ),
    ...
    PDETMunicipality(
        "Belén de los Andaquíes", "Caquetá", PDETSubregion.CAGUAN, 11000, 1168.0, "18094"
    ),
    PDETMunicipality(
        "Cartagena del Chairá", "Caquetá", PDETSubregion.CAGUAN, 35000, 12704.0, "18150"
    ),
    ...
    PDETMunicipality(
        "San José del Fragua", "Caquetá", PDETSubregion.CAGUAN, 14000, 3938.0, "18610"
    ),
    PDETMunicipality(
        "San Vicente del Caguán", "Caquetá", PDETSubregion.CAGUAN, 64000, 24466.0, "18753"
    ),
    ...
    PDETMunicipality(
        "Convención", "Norte de Santander", PDETSubregion.CATATUMBO, 19000, 1171.0, "54206"
    ),
    PDETMunicipality(
        "El Carmen", "Norte de Santander", PDETSubregion.CATATUMBO, 15000, 1186.0, "54245"
    ),
    PDETMunicipality(
        "El Tarra", "Norte de Santander", PDETSubregion.CATATUMBO, 13000, 690.0, "54250"
    ),
    PDETMunicipality(
        "Hacarí", "Norte de Santander", PDETSubregion.CATATUMBO, 14000, 549.0, "54344"
    ),
    PDETMunicipality(
        "San Calixto", "Norte de Santander", PDETSubregion.CATATUMBO, 12000, 1155.0, "54660"
    ),
    PDETMunicipality(
        "Sardinata", "Norte de Santander", PDETSubregion.CATATUMBO, 26000, 1398.0, "54720"
    ),
    PDETMunicipality(
        "Teorama", "Norte de Santander", PDETSubregion.CATATUMBO, 19000, 1126.0, "54800"
    ),
    ...
    PDETMunicipality(
        "San José del Guaviare", "Guaviare", PDETSubregion.MACARENA, 64000, 16592.0, "95001"
    ),
    ...
    PDETMunicipality(
        "El Carmen de Bolívar", "Bolívar", PDETSubregion.MONTES_MARIA, 76000, 954.0, "13244"
    ),
    ...
    PDETMunicipality(
        "San Juan Nepomuceno", "Bolívar", PDETSubregion.MONTES_MARIA, 39000, 547.0, "13657"
    ),
    ...
    PDETMunicipality(
        "Buenaventura", "Valle del Cauca", PDETSubregion.PACIFICO_MEDIO, 424000, 6297.0, "76109"
    ),
    # PACÍFICO Y FRONTERA NARIÑENSE (11 municipalities)
    PDETMunicipality(
        "Barbacoas", "Nariño", PDETSubregion.PACIFICO_NARINENSE, 24000, 1674.0, "52083"
    ),
    PDETMunicipality(
        "El Charco", "Nariño", PDETSubregion.PACIFICO_NARINENSE, 32000, 2485.0, "52250"
    ),
    PDETMunicipality(
        "Francisco Pizarro", "Nariño", PDETSubregion.PACIFICO_NARINENSE, 13000, 1585.0, "52317"
    ),
    PDETMunicipality("La Tola", "Nariño", PDETSubregion.PACIFICO_NARINENSE, 7000, 421.0, "52378"),
    PDETMunicipality(
        "Magüí Payán", "Nariño", PDETSubregion.PACIFICO_NARINENSE, 23000, 1621.0, "52435"
    ),
    PDETMunicipality(
        "Mosquera", "Nariño", PDETSubregion.PACIFICO_NARINENSE, 12000, 1026.0, "52473"
    ),
    PDETMunicipality(
        "Olaya Herrera", "Nariño", PDETSubregion.PACIFICO_NARINENSE, 32000, 1932.0, "52490"
    ),
    PDETMunicipality(
        "Roberto Payán", "Nariño", PDETSubregion.PACIFICO_NARINENSE, 18000, 1333.0, "52621"
    ),
    PDETMunicipality(
        "Santa Bárbara", "Nariño", PDETSubregion.PACIFICO_NARINENSE, 9000, 1398.0, "52683"
    ),
    ...
    PDETMunicipality(
        "Valle del Guamuéz", "Putumayo", PDETSubregion.PUTUMAYO, 49000, 1257.0, "86865"
    ),
    ...
    PDETMunicipality(
        "Agustín Codazzi", "Cesar", PDETSubregion.SIERRA_NEVADA, 62000, 2048.0, "20013"
    ),
    PDETMunicipality("Becerril", "Cesar", PDETSubregion.SIERRA_NEVADA, 18000, 690.0, "20045"),
    PDETMunicipality(
        "La Jagua de Ibirico", "Cesar", PDETSubregion.SIERRA_NEVADA, 22000, 720.0, "20383"
    ),
    PDETMunicipality("La Paz", "Cesar", PDETSubregion.SIERRA_NEVADA, 26000, 1238.0, "20400"),
    PDETMunicipality(
        "Manaure Balcón del Cesar", "Cesar", PDETSubregion.SIERRA_NEVADA, 15000, 1047.0, "20443"
    ),
    ...
    PDETMunicipality(
        "San Juan del Cesar", "La Guajira", PDETSubregion.SIERRA_NEVADA, 40000, 1671.0, "44650"
    ),
    ...
    PDETMunicipality(
        "Santa Marta", "Magdalena", PDETSubregion.SIERRA_NEVADA, 500000, 2381.0, "47001"
    ),
    ...
    PDETMunicipality(
        "Santa Rosa del Sur", "Bolívar", PDETSubregion.SUR_BOLIVAR, 39000, 1749.0, "13688"
    ),
    ...
    PDETMunicipality(
        "Puerto Libertador", "Córdoba", PDETSubregion.SUR_CORDOBA, 39000, 2903.0, "23570"
    ),
    PDETMunicipality(
        "San José de Uré", "Córdoba", PDETSubregion.SUR_CORDOBA, 12000, 1298.0, "23682"
    ),
