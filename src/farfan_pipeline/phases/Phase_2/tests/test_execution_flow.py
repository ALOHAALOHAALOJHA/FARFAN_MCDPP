...
class TestSequentialFlowInvariants:
    ...
    def test_tasks_processed_one_at_a_time(self) -> None:
        ...
        assert (
            "for " in method_body and "task" in method_body.lower()
    ...
    def test_results_collected_in_order(self) -> None:
        ...
        assert (
            "results.append" in content or "results: list" in content.lower()
...
class TestPlanIntegrityHash:
    ...
    def test_execution_plan_has_plan_id(self) -> None:
        ...
        assert found_plan_id, "ExecutionPlan MUST include plan_id for integrity verification."
...
class TestNoInsularSubflows:
    ...
    def test_no_standalone_execution_scripts(self) -> None:
        ...
        if violations:
            pytest.warns(UserWarning, f"Potential standalone execution scripts: {violations}")
