"""
Signal-Enriched Primitives - Phase 4-7
========================================

This module provides signal-enriched aggregation primitives for the
hierarchical aggregation pipeline. It extends standard aggregation with
signal-based enhancements for:

1. Context-aware weight adjustments
2. Signal-driven dispersion analysis
3. Pattern-based aggregation method selection
4. Enhanced aggregation provenance with signal metadata
