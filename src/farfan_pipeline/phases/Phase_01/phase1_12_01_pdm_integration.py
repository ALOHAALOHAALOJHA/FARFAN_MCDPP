...
try:
    from farfan_pipeline.pdm.contracts import (
        PDMProfileContract,
        PrerequisiteError,
        SP2Obligations,
        SP4Obligations,
...
def enhance_sp2_with_pdm(
    ...
    Example:
        >>> from farfan_pipeline.phases.Phase_01.phase1_12_01_pdm_integration import enhance_sp2_with_pdm
...
def assign_pdm_metadata_to_chunks(
    ...
    Example:
        >>> from farfan_pipeline.phases.Phase_01.phase1_12_01_pdm_integration import assign_pdm_metadata_to_chunks
