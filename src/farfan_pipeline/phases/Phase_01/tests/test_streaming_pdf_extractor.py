...
from farfan_pipeline.phases.Phase_01.primitives.streaming_extractor import (
    StreamingPDFExtractor,
    PYMUPDF_AVAILABLE,
)
from farfan_pipeline.phases.Phase_01.PHASE_1_CONSTANTS import PDF_EXTRACTION_CHAR_LIMIT
...
class TestStreamingPDFExtractorValidation(unittest.TestCase):
    ...
    @patch('farfan_pipeline.phases.Phase_01.primitives.streaming_extractor.PYMUPDF_AVAILABLE', False)
...
class TestStreamingPDFExtractorWithMockPDF(unittest.TestCase):
    ...
    @patch('farfan_pipeline.phases.Phase_01.primitives.streaming_extractor.fitz')
