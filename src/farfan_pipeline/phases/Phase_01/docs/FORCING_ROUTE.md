...
[EXEC-CPP-003] | SCHEMA | schema_version DEBE ser "CPP-2025.1" | cpp_output.schema_version == "CPP-2025.1" | FATAL: Terminar pipeline
...
[POST-005] | SCHEMA | schema_version DEBE ser "CPP-2025.1" | cpp.schema_version == "CPP-2025.1" | FATAL: Terminar pipeline
...
14.1 CPPAdapter.to_preprocessed_document()
...
[INV-005] | SCHEMA VERSION | schema_version DEBE ser "CPP-2025.1" en CPP | cpp.schema_version == "CPP-2025.1" | FATAL: INVARIANTE CONSTITUCIONAL ABSOLUTO VIOLADO - PIPELINE TERMINADO
...
````markdown
# IMPLEMENTACIÓN OBLIGATORIA: PHASE 1 CPP INGESTION

## CONTEXTO
Eres un ingeniero de software senior implementando la Fase 1 del pipeline CPP Ingestion.
...
Implementa Phase1CPPIngestionFullContract siguiendo este checklist al pie de la letra.
