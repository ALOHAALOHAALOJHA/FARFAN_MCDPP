"""
Module: src.farfan_pipeline.phases.Phase_08.phase8_30_00_signal_enriched_recommendations
        ...
        try:
            ...
            if self.signal_registry:
                try:
                    ...
                    causal_patterns = [
                        p for p in patterns if "caus" in str(p).lower() or "efect" in str(p).lower()
                    ]
