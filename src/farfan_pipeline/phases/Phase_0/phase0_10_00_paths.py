...
def _detect_project_root() -> Path:
    ...
    2. Secondary strategy: Search for src/farfan_pipeline (or legacy src/farfan_core) layout
       - Looks for directories with src/farfan_pipeline (or src/farfan_core) and setup.py
