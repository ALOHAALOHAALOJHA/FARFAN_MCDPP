...
Ubicación: src/farfan_pipeline/phases/Phase_02/contract_generator/contract_assembler.py
...
class ContractAssembler:
    ...
    def _build_executor_binding(
        ...
        return {
            ...
            "executor_module": "farfan_pipeline.phases.Phase_02.executors",
            "contract_number": contract_number,
        }
    ...
    def _build_evidence_assembly(
        ...
        return {
            ...
            "module": "farfan_pipeline. phases.Phase_02.evidence_nexus",
