...
class TestPhase2FactoryAndRegistry:
    ...
    def test_class_registry_initialization(self):
        ...
        from farfan_pipeline.phases.Phase_02.phase2_10_01_class_registry import ClassRegistry
    ...
    def test_methods_registry_initialization(self):
        ...
        from farfan_pipeline.phases.Phase_02.phase2_10_02_methods_registry import MethodsRegistry
...
class TestPhase2TaskExecutor:
    ...
    def test_dynamic_executor_base_slot_derivation(self):
        ...
        from farfan_pipeline.phases.Phase_02.phase2_50_00_task_executor import DynamicContractExecutor
    ...
    def test_checkpoint_manager(self, tmp_checkpoint_dir):
        ...
        from farfan_pipeline.phases.Phase_02.phase2_50_00_task_executor import CheckpointManager
...
class TestPhase2EvidenceNexus:
    ...
    def test_evidence_nexus_initialization(self):
        ...
        from farfan_pipeline.phases.Phase_02.phase2_80_00_evidence_nexus import EvidenceNexus
    ...
    def test_evidence_edge_creation(self):
        ...
        from farfan_pipeline.phases.Phase_02.phase2_80_00_evidence_nexus import EvidenceEdge, RelationType
...
class TestPhase2Carver:
    ...
    def test_quality_level_thresholds(self):
        ...
        from farfan_pipeline.phases.Phase_02.phase2_90_00_carver import QualityLevel
...
class TestPhase2ResourceManager:
    ...
    def test_resource_pressure_levels(self):
        ...
        from farfan_pipeline.phases.Phase_02.phase2_30_00_resource_manager import ResourcePressureLevel
    ...
    def test_executor_priority_ordering(self):
        ...
        from farfan_pipeline.phases.Phase_02.phase2_30_00_resource_manager import ExecutorPriority
