...
def test_adapter_basic_functionality(valid_macro_score, valid_phase5_output):
    ...
    from farfan_pipeline.phases.Phase_8.contracts.phase7_to_phase8_adapter import Phase7To8Adapter
...
def test_adapter_integration_with_phase8_input_contract(valid_macro_score, valid_phase5_output):
    ...
    """
    from farfan_pipeline.phases.Phase_8.contracts.phase7_to_phase8_adapter import Phase7To8Adapter
    from farfan_pipeline.phases.Phase_8.contracts.phase8_input_contract import validate_phase8_input_contract
