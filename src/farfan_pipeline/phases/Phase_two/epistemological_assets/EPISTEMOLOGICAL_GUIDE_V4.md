...
|------|--------|-----------|------|-------------------------------|
| Semántico | TYPE_A | Q001, Q013 | Coherencia narrativa, NLP | `semantic_bundling` + `dempster_shafer` |
| Bayesiano | TYPE_B | Q002, Q005, Q007, Q011, Q017, Q018, Q020, Q023, Q024, Q025, Q027, Q029 | Significancia estadística, priors | `evidence_concatenation` + `bayesian_update` |
| Causal | TYPE_C | Q008, Q016, Q026, Q030 | Topología de grafos, DAGs | `graph_element_collection` + `topological_overlay` |
| Financiero | TYPE_D | Q003, Q004, Q006, Q009, Q012, Q015, Q021, Q022 | Suficiencia presupuestal | `financial_aggregation` + `weighted_financial_mean` |
| Lógico | TYPE_E | Q010, Q014, Q019, Q028 | Detección de contradicciones | `fact_collation` + `contradiction_dominance` |
...
"assembly_rules": [
  {
    ...
    "output_type": "FACT",
    "confidence_propagation": "preserve_context"
  },
  {
    ...
    "input_dependencies": ["semantic_bundles"],
    "merge_strategy": "dempster_shafer",
    "operation": "Combine belief masses from multiple sources",
    "output_type": "PARAMETER",
    "confidence_propagation":  "dempster_rule"
  },
  {
    "rule_id": "R3_audit_veto",
    "rule_type": "robustness_gate",
    "target": "validated_belief",
    "sources": ["<todos los provides de N3>"],
    "input_dependencies":  ["semantic_bundles", "belief_mass"],
    "merge_strategy": "contradiction_veto",
    "output_type": "CONSTRAINT",
    "gate_logic": {
      "semantic_contradiction": {"action": "veto_bundle", "multiplier": 0.0}
    }
  },
  {
    ...
    "target":  "human_answer",
    "sources": [],
    "input_dependencies": ["validated_belief"],
...
"assembly_rules": [
  ...
  },
  {
    ...
    "input_dependencies": ["evidence_array"],
...
"assembly_rules":  [
  ...
  },
  {
    ...
    "input_dependencies": ["graph_elements"],
    "merge_strategy": "topological_overlay",
    "operation": "Overlay partial graphs and check topology",
    "output_type": "PARAMETER"
  },
  {
    ...
    "input_dependencies":  ["weighted_dag"],
  ...
  },
  {
    ...
    "rule_type": "synthesis",
    "target": "human_answer",
    "input_dependencies": ["validated_dag"],
    "merge_strategy":  "carver_doctoral_synthesis",
    "output_type":  "NARRATIVE"
  }
]
...
"assembly_rules":  [
  ...
  },
  {
    ...
    "input_dependencies": ["normalized_financials"],
  ...
  },
  {
    ...
    "input_dependencies": ["normalized_financials", "sufficiency_index"],
    "merge_strategy": "sufficiency_gate",
    "gate_logic": {
      "budget_gap_critical": {"action": "block_branch", "multiplier": 0.0},
      "budget_gap_moderate": {"action": "reduce_confidence", "multiplier": 0.3}
    },
    "output_type":  "CONSTRAINT"
  },
  {
    ...
    "rule_type":  "synthesis",
    "target": "human_answer",
    "input_dependencies":  ["validated_viability"],
    "merge_strategy": "carver_doctoral_synthesis",
    "output_type": "NARRATIVE"
  }
]
...
"assembly_rules": [
  ...
  },
  {
    ...
    "input_dependencies": ["logical_facts", "consistency_status"],
    "merge_strategy": "contradiction_dominance",
    "gate_logic": {
      "any_contradiction":  {"action": "invalidate_all", "multiplier":  0.0}
    },
    "output_type": "CONSTRAINT"
  },
  {
    ...
    "rule_type": "synthesis",
    "target": "human_answer",
    "input_dependencies": ["validated_logic"],
    "merge_strategy": "carver_doctoral_synthesis",
    "output_type": "NARRATIVE"
  }
]
...
|------|-------------|-------------|-------------|
| TYPE_A (Semántico) | `semantic_bundling` | `dempster_shafer` | `contradiction_veto` |
| TYPE_B (Bayesiano) | `evidence_concatenation` | `bayesian_update` | `statistical_gate` |
| TYPE_C (Causal) | `graph_element_collection` | `topological_overlay` | `cycle_detection_veto` |
| TYPE_D (Financiero) | `financial_aggregation` | `weighted_financial_mean` | `sufficiency_gate` |
| TYPE_E (Lógico) | `fact_collation` | `logical_consistency_check` | `contradiction_dominance` |
