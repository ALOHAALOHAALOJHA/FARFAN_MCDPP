...
class VerifiedPipelineRunner:
    ...
    def __init__(
        ...
        try:
            ...
            self._log_bootstrap("artifacts_dir_created", {"path": str(self.artifacts_dir)})
        except Exception as e:
    ...
    def verify_input(self, expected_hashes: dict[str, str] | None = None) -> bool:
        ...
        if expected_hashes:
            print(
                "[P0.1] Hash validation enabled (will verify against expected values)", flush=True
            )
        ...
        try:
            ...
            print(
                f"[P0.1] Questionnaire file hashed (integrity only): {self.questionnaire_sha256[:16]}...",
                flush=True,
            )
            print("[P0.1] ℹ️  Content will be loaded by Factory after Phase 0 passes", flush=True)
        except Exception as e:
        ...
        if expected_hashes:
            ...
            if "pdf" in expected_hashes:
                ...
                if self.input_pdf_sha256 != expected_pdf:
                    ...
                    print("[P0.1] ✓ PDF hash validated against expected value", flush=True)
            ...
            if "questionnaire" in expected_hashes:
                ...
                if self.questionnaire_sha256 != expected_q:
                    ...
                    print(
                        "[P0.1] ✓ Questionnaire hash validated against expected value", flush=True
                    )
    ...
    def run_boot_checks(self) -> bool:
        ...
        try:
            ...
            print(
                f"[P0.2] WARNING: {e} (continuing in {self.runtime_config.mode.value} mode)",
                flush=True,
            )
            return False
    ...
    def initialize_determinism(self) -> bool:
        ...
        seeds, status, errors = initialize_determinism_from_registry(
            self.seed_registry, self.policy_unit_id, self.correlation_id
        )
        ...
        # Log seeding success
        print("[P0.3] Seeds applied:", flush=True)
