...
class TestPhase4ModuleImports:
    ...
    def test_import_primitives_layer(self):
        ...
        from farfan_pipeline.phases.Phase_4.primitives import (
            AggregationSettings,
            IAggregator,
            IConfigBuilder,
        )
    ...
    def test_import_contracts(self):
        ...
        from farfan_pipeline.phases.Phase_4.contracts.phase4_input_contract import Phase4InputContract
        from farfan_pipeline.phases.Phase_4.contracts.phase4_mission_contract import Phase4MissionContract
        from farfan_pipeline.phases.Phase_4.contracts.phase4_output_contract import Phase4OutputContract
    ...
    def test_import_aggregation_settings(self):
        ...
        from farfan_pipeline.phases.Phase_4.phase4_10_00_aggregation_settings import AggregationSettings
        assert AggregationSettings is not None
    
    def test_import_choquet_adapter(self):
        """Test importing Choquet adapter."""
        from farfan_pipeline.phases.Phase_4.phase4_10_00_choquet_adapter import create_default_choquet_adapter
...
class TestPhase4LayerDependencies:
    ...
    def test_contracts_can_import_primitives(self):
        ...
        from farfan_pipeline.phases.Phase_4.contracts.phase4_input_contract import Phase4InputContract
        from farfan_pipeline.phases.Phase_4.primitives import AggregationSettings
    ...
    def test_aggregation_imports_primitives_and_choquet(self):
        ...
        from farfan_pipeline.phases.Phase_4.phase4_10_00_aggregation import DimensionAggregator
        from farfan_pipeline.phases.Phase_4.phase4_10_00_choquet_adapter import create_default_choquet_adapter
        from farfan_pipeline.phases.Phase_4.primitives import AggregationSettings
