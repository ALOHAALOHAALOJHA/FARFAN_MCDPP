...
def validate_determinism(
    ...
    """
    if (manifest1.determinism_seeds.random_seed != manifest2.determinism_seeds.random_seed or
        manifest1.determinism_seeds.numpy_seed != manifest2.determinism_seeds.numpy_seed):
        return True
