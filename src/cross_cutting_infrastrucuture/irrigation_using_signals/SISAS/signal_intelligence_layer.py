...
from cross_cutting_infrastrucuture.irrigation_using_signals.SISAS.pdt_quality_integration import (
    PDTQualityMetrics,
    apply_pdt_quality_boost,
    compute_pdt_section_quality,
    track_pdt_precision_correlation,
)
from cross_cutting_infrastrucuture.irrigation_using_signals.SISAS.signal_context_scoper import (
...
from cross_cutting_infrastrucuture.irrigation_using_signals.SISAS.signal_evidence_extractor import (
    EvidenceExtractionResult,
    extract_structured_evidence,
)
from cross_cutting_infrastrucuture.irrigation_using_signals.SISAS.signal_semantic_expander import (
    expand_all_patterns,
