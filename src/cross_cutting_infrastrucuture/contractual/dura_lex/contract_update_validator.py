...
class ContractUpdateValidator:
    ...
    def __init__(self):
        self.contracts_dir = SRC_ROOT / "canonic_phases" / "Phase_two" / "json_files_phase_two" / "executor_contracts" / "specialized"
    ...
    def create_change_manifest(
        ...
        for old_class, old_method, new_class, new_method in replacements:
            ...
            self.validation_results["affected_contracts"].extend([c.name for c in affected_contracts])
...
def main():
    ...
    high_priority_replacements = [
        ("FinancialAuditor", "_calculate_sufficiency", "PDETMunicipalPlanAnalyzer", "_assess_financial_sustainability"),
        ("FinancialAuditor", "_detect_allocation_gaps", "PDETMunicipalPlanAnalyzer", "_analyze_funding_sources"),
        ("FinancialAuditor", "_match_goal_to_budget", "PDETMunicipalPlanAnalyzer", "_extract_budget_for_pillar"),
    ]
