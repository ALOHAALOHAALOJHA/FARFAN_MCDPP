...
El contrato Q046.v3.json alcanza 61.0/100 puntos.
...
- ✅ `question_id`: identity=Q046, schema=Q046 [5 pts]
- ✅ `policy_area_id`: identity=PA10, schema=PA10 [5 pts]
- ✅ `dimension_id`: identity=DIM04, schema=DIM04 [5 pts]
- ✅ `question_global`: identity=46, schema=46 [3 pts]
- ✅ `base_slot`: identity=D4-Q1, schema=D4-Q1 [2 pts]
...
**Evaluación**:
- Method count: 16 métodos declarados
- Provides declarations: 16 namespaces
...
### Warnings (7)
- ⚠️ A2: Low method usage ratio: 6.2% (1/16)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'horizonte_temporal', 'linea_base_resultado', 'meta_resultado', 'metrica_outcome'}
...
**Generado**: 2025-12-17T02:54:49.597482  
