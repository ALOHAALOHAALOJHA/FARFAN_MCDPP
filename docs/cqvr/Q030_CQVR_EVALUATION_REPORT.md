...
El contrato Q030.v3.json alcanza 61.0/100 puntos.
...
- ✅ `question_id`: identity=Q030, schema=Q030 [5 pts]
- ✅ `policy_area_id`: identity=PA01, schema=PA01 [5 pts]
- ✅ `dimension_id`: identity=DIM06, schema=DIM06 [5 pts]
- ✅ `question_global`: identity=30, schema=30 [3 pts]
- ✅ `base_slot`: identity=D6-Q5, schema=D6-Q5 [2 pts]
...
**Evaluación**:
- Method count: 9 métodos declarados
- Provides declarations: 9 namespaces
- Assembly sources: 1 referencias
- Orphan sources: 0 ✅
...
### Warnings (7)
- ⚠️ A2: Low method usage ratio: 11.1% (1/9)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'enfoque_diferencial', 'analisis_contextual'}
...
**Generado**: 2025-12-17T02:54:49.585161  
