...
El contrato Q050.v3.json alcanza 61.0/100 puntos.
...
- ✅ `question_id`: identity=Q050, schema=Q050 [5 pts]
- ✅ `policy_area_id`: identity=PA10, schema=PA10 [5 pts]
- ✅ `dimension_id`: identity=DIM04, schema=DIM04 [5 pts]
- ✅ `question_global`: identity=50, schema=50 [3 pts]
- ✅ `base_slot`: identity=D4-Q5, schema=D4-Q5 [2 pts]
...
**Evaluación**:
- Method count: 6 métodos declarados
- Provides declarations: 6 namespaces
...
- ⚠️ B3: Required elements not in validation rules: {'alineacion_otros_marcos', 'alineacion_ods', 'alineacion_pnd'}
...
**Generado**: 2025-12-17T02:54:49.600437  
