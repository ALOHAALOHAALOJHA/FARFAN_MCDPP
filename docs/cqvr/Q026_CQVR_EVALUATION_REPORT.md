...
El contrato Q026.v3.json alcanza 61.0/100 puntos.
...
- ✅ `question_id`: identity=Q026, schema=Q026 [5 pts]
- ✅ `policy_area_id`: identity=PA01, schema=PA01 [5 pts]
- ✅ `dimension_id`: identity=DIM06, schema=DIM06 [5 pts]
- ✅ `question_global`: identity=26, schema=26 [3 pts]
- ✅ `base_slot`: identity=D6-Q1, schema=D6-Q1 [2 pts]
...
- ⚠️ B3: Required elements not in validation rules: {'teoria_cambio_explicita', 'diagrama_causal', 'supuestos_verificables'}
...
**Generado**: 2025-12-17T02:54:49.582306  
