...
El contrato Q047.v3.json alcanza 61.0/100 puntos.
...
- ✅ `question_id`: identity=Q047, schema=Q047 [5 pts]
- ✅ `policy_area_id`: identity=PA10, schema=PA10 [5 pts]
- ✅ `dimension_id`: identity=DIM04, schema=DIM04 [5 pts]
- ✅ `question_global`: identity=47, schema=47 [3 pts]
- ✅ `base_slot`: identity=D4-Q2, schema=D4-Q2 [2 pts]
...
- ⚠️ B3: Required elements not in validation rules: {'condiciones_habilitantes', 'supuestos_identificados', 'cadena_causal_explicita'}
...
**Generado**: 2025-12-17T02:54:49.598128  
