...
El contrato Q035.v3.json alcanza 61.0/100 puntos.
...
- ✅ `question_id`: identity=Q035, schema=Q035 [5 pts]
- ✅ `policy_area_id`: identity=PA10, schema=PA10 [5 pts]
- ✅ `dimension_id`: identity=DIM01, schema=DIM01 [5 pts]
- ✅ `question_global`: identity=35, schema=35 [3 pts]
- ✅ `base_slot`: identity=D1-Q5, schema=D1-Q5 [2 pts]
...
- ⚠️ B3: Required elements not in validation rules: {'coherencia_demostrada', 'restricciones_presupuestales', 'restricciones_legales', 'restricciones_competencias'}
...
**Generado**: 2025-12-17T02:54:49.588942  
