...
- ✅ `question_id`: identity=Q152, schema=Q152
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM01, schema=DIM01
- ✅ `question_global`: identity=152, schema=152
- ✅ `base_slot`: identity=D1-Q2, schema=D1-Q2
...
- **Method count**: 12 (declared: 12)
- **Provides defined**: 12
- **Sources referenced**: 0
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 12

⚠️ **Many unused methods**: 12/12
...
- ⚠️ B3: Required elements not in validation rules: {'vacios_explicitos', 'cuantificacion_magnitud', 'analisis_causal_problema'}
...
El contrato Q152.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.877409  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
