...
- ✅ `question_id`: identity=Q167, schema=Q167
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM04, schema=DIM04
- ✅ `question_global`: identity=167, schema=167
- ✅ `base_slot`: identity=D4-Q2, schema=D4-Q2
...
El contrato Q167.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.893065  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
