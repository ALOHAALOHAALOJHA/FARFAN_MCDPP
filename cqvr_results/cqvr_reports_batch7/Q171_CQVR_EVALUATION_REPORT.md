...
- ✅ `question_id`: identity=Q171, schema=Q171
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM05, schema=DIM05
- ✅ `question_global`: identity=171, schema=171
- ✅ `base_slot`: identity=D5-Q1, schema=D5-Q1
...
- ⚠️ B3: Required elements not in validation rules: {'impacto_definido', 'rezago_temporal', 'ruta_transmision'}
...
El contrato Q171.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.895861  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
