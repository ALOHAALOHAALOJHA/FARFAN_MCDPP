...
- ✅ `question_id`: identity=Q165, schema=Q165
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM03, schema=DIM03
- ✅ `question_global`: identity=165, schema=165
- ✅ `base_slot`: identity=D3-Q5, schema=D3-Q5
...
- **Method count**: 25 (declared: 25)
- **Provides defined**: 25
- **Sources referenced**: 0
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 25

⚠️ **Many unused methods**: 25/25
...
- ⚠️ A2: Low method usage ratio: 0.0% (0/25)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'conexion_producto_resultado', 'mecanismo_causal_explicito'}
...
El contrato Q165.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.891467  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
