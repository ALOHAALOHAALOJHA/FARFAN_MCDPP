...
| **TIER 3: Componentes de Calidad** | **10.0/15** | ≥8 | ✅ APROBADO |
| **TOTAL** | **64.0/100** | ≥80 | ⚠️ MEJORAR |

**VEREDICTO**: ❌ **REFORMULAR**

Contract requires reformulation: Tier 1: 39.0/55.0 (70.9%) < threshold 35.0, Total: 64.0/100.0 (64.0%). Critical blockers: 1. Contract needs substantial rework.
...
- ✅ `question_id`: identity=Q151, schema=Q151
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM01, schema=DIM01
- ✅ `question_global`: identity=151, schema=151
- ✅ `base_slot`: identity=D1-Q1, schema=D1-Q1
...
- **Method count**: 17 (declared: 17)
- **Provides defined**: 17
- **Sources referenced**: 8
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 9

⚠️ **Many unused methods**: 9/17
...
## TIER 3: COMPONENTES DE CALIDAD - 10.0/15 pts ✅ APROBADO
...
### TIER 3 SUBTOTAL: 10.0/15 pts (66.7%)
...
| **TIER 3: Calidad** | 10.0 | 15 | 66.7% | ✅ APROBADO |
| **TOTAL** | **64.0** | **100** | **64.0%** | ⚠️ MEJORAR |
...
- ⚠️ A2: Low method usage ratio: 47.1% (8/17)
...
El contrato Q151.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:

- **Score total**: 64.0/100 (64.0%)
- **Decisión**: REFORMULAR
- **Blockers críticos**: 1
- **Warnings**: 5
...
**Generado**: 2025-12-17T09:28:12.875551  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
