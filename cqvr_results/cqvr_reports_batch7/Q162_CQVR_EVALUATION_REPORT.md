...
- ✅ `question_id`: identity=Q162, schema=Q162
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM03, schema=DIM03
- ✅ `question_global`: identity=162, schema=162
- ✅ `base_slot`: identity=D3-Q2, schema=D3-Q2
...
- **Method count**: 21 (declared: 21)
- **Provides defined**: 21
- **Sources referenced**: 0
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 21

⚠️ **Many unused methods**: 21/21
...
- ⚠️ B3: Required elements not in validation rules: {'proporcionalidad_meta_problema'}
...
El contrato Q162.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.888494  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
