...
- ✅ `question_id`: identity=Q173, schema=Q173
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM05, schema=DIM05
- ✅ `question_global`: identity=173, schema=173
- ✅ `base_slot`: identity=D5-Q3, schema=D5-Q3
...
- **Method count**: 6 (declared: 6)
- **Provides defined**: 6
- **Sources referenced**: 0
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 6

⚠️ **Many unused methods**: 6/6
...
- ⚠️ A2: Low method usage ratio: 0.0% (0/6)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'documenta_validez', 'proxy_para_intangibles', 'reconoce_limitaciones'}
...
El contrato Q173.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.897641  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
