...
- ✅ `question_id`: identity=Q158, schema=Q158
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM02, schema=DIM02
- ✅ `question_global`: identity=158, schema=158
- ✅ `base_slot`: identity=D2-Q3, schema=D2-Q3
...
- ⚠️ A2: Low method usage ratio: 0.0% (0/9)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'vinculo_diagnostico_actividad', 'aborda_causa_raiz'}
...
El contrato Q158.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.885362  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
