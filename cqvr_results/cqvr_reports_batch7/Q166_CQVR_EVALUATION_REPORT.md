...
- ✅ `question_id`: identity=Q166, schema=Q166
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM04, schema=DIM04
- ✅ `question_global`: identity=166, schema=166
- ✅ `base_slot`: identity=D4-Q1, schema=D4-Q1
...
- **Method count**: 16 (declared: 16)
- **Provides defined**: 16
- **Sources referenced**: 1
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 15

⚠️ **Many unused methods**: 15/16
...
- ⚠️ B3: Required elements not in validation rules: {'linea_base_resultado', 'metrica_outcome', 'horizonte_temporal', 'meta_resultado'}
...
El contrato Q166.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.892347  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
