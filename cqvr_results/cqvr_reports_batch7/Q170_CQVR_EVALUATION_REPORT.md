...
- ✅ `question_id`: identity=Q170, schema=Q170
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM04, schema=DIM04
- ✅ `question_global`: identity=170, schema=170
- ✅ `base_slot`: identity=D4-Q5, schema=D4-Q5
...
- ⚠️ B3: Required elements not in validation rules: {'alineacion_pnd', 'alineacion_ods', 'alineacion_acuerdo_paz'}
...
El contrato Q170.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.895167  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
