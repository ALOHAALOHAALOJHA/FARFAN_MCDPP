...
- ✅ `question_id`: identity=Q156, schema=Q156
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM02, schema=DIM02
- ✅ `question_global`: identity=156, schema=156
- ✅ `base_slot`: identity=D2-Q1, schema=D2-Q1
...
- ⚠️ B3: Required elements not in validation rules: {'columna_costo', 'formato_tabular', 'columna_producto', 'columna_responsable', 'columna_cronograma'}
...
El contrato Q156.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.883821  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
