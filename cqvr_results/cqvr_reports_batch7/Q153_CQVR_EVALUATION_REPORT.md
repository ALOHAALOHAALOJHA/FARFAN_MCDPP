...
- ✅ `question_id`: identity=Q153, schema=Q153
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM01, schema=DIM01
- ✅ `question_global`: identity=153, schema=153
- ✅ `base_slot`: identity=D1-Q3, schema=D1-Q3
...
- **Method count**: 13 (declared: 13)
- **Provides defined**: 13
- **Sources referenced**: 0
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 13

⚠️ **Many unused methods**: 13/13
...
- ⚠️ A2: Low method usage ratio: 0.0% (0/13)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'asignacion_explicita', 'suficiencia_justificada', 'trazabilidad_ppi_bpin'}
...
El contrato Q153.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.880552  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
