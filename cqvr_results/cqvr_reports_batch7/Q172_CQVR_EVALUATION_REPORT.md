...
- ✅ `question_id`: identity=Q172, schema=Q172
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM05, schema=DIM05
- ✅ `question_global`: identity=172, schema=172
- ✅ `base_slot`: identity=D5-Q2, schema=D5-Q2
...
- **Method count**: 28 (declared: 28)
- **Provides defined**: 28
- **Sources referenced**: 0
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 28

⚠️ **Many unused methods**: 28/28
...
- ⚠️ A2: Low method usage ratio: 0.0% (0/28)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'usa_proxies', 'usa_indices_compuestos', 'justifica_validez'}
...
El contrato Q172.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.896923  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
