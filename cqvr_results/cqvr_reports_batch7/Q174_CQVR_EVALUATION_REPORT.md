...
- ✅ `question_id`: identity=Q174, schema=Q174
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM05, schema=DIM05
- ✅ `question_global`: identity=174, schema=174
- ✅ `base_slot`: identity=D5-Q4, schema=D5-Q4
...
- ⚠️ B3: Required elements not in validation rules: {'alineacion_marcos', 'riesgos_sistemicos'}
...
El contrato Q174.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.898346  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
