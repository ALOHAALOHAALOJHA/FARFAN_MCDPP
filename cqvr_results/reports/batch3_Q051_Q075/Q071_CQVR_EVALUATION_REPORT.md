...
1. ⚠️ A2: Low method usage ratio: 12.5% (1/8)
2. ⚠️ A4: source_hash is placeholder or missing
3. ⚠️ B2: No methodological_depth.methods defined
4. ⚠️ B3: Required elements not in validation rules: {'meta_cuantitativa', 'linea_base_producto', 'fuente_verificacion'}
...
Timestamp: `2025-12-17T02:48:18.882716`  
