...
El contrato Q041.v3.json alcanza 61.0/100 puntos.
...
- ✅ `question_id`: identity=Q041, schema=Q041 [5 pts]
- ✅ `policy_area_id`: identity=PA10, schema=PA10 [5 pts]
- ✅ `dimension_id`: identity=DIM03, schema=DIM03 [5 pts]
- ✅ `question_global`: identity=41, schema=41 [3 pts]
- ✅ `base_slot`: identity=D3-Q1, schema=D3-Q1 [2 pts]
...
**Evaluación**:
- Method count: 8 métodos declarados
- Provides declarations: 8 namespaces
...
### Warnings (7)
- ⚠️ A2: Low method usage ratio: 12.5% (1/8)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'meta_cuantitativa', 'linea_base_producto', 'fuente_verificacion'}
...
**Generado**: 2025-12-17T02:54:49.593006  
