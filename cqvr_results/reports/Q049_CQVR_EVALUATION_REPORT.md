...
El contrato Q049.v3.json alcanza 61.0/100 puntos.
...
- ✅ `question_id`: identity=Q049, schema=Q049 [5 pts]
- ✅ `policy_area_id`: identity=PA10, schema=PA10 [5 pts]
- ✅ `dimension_id`: identity=DIM04, schema=DIM04 [5 pts]
- ✅ `question_global`: identity=49, schema=49 [3 pts]
- ✅ `base_slot`: identity=D4-Q4, schema=D4-Q4 [2 pts]
...
- ⚠️ B3: Required elements not in validation rules: {'vinculo_resultado_problema', 'criterios_exito_definidos'}
...
**Generado**: 2025-12-17T02:54:49.599820  
