...
```json
{
    ...
    "created_at": "2025-11-28T03:49:29.849102+00:00",
    "updated_at": "2025-12-16T04:42:57.410060+00:00"
}
```
...
|-------|----------|--------|-------|
| question_id | Q019 | Q019 | ✅ |
| policy_area_id | PA01 | PA01 | ✅ |
| dimension_id | DIM04 | DIM04 | ✅ |
| question_global | 19 | 19 | ✅ |
| base_slot | D4-Q4 | D4-Q4 | ✅ |
...
4. B3: Required elements not in validation rules: {'vinculo_resultado_problema', 'criterios_exito_definidos'}
