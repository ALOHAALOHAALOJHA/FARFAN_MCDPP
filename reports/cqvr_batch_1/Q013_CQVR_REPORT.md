...
```json
{
    ...
    "created_at": "2025-11-28T03:49:29.823196+00:00",
    "updated_at": "2025-12-16T04:42:57.373885+00:00"
}
```
...
|-------|----------|--------|-------|
| question_id | Q013 | Q013 | ✅ |
| policy_area_id | PA01 | PA01 | ✅ |
| dimension_id | DIM03 | DIM03 | ✅ |
| question_global | 13 | 13 | ✅ |
| base_slot | D3-Q3 | D3-Q3 | ✅ |

#### A2. Alineación Method-Assembly (20 pts máx)

- **Métodos definidos**: 22
- **Reglas de ensamblaje**: 4
- **Namespaces provistos**: 22
...
1. A2: Low method usage ratio: 0.0% (0/22)
2. A4: source_hash is placeholder or missing
3. B2: No methodological_depth.methods defined
4. B3: Required elements not in validation rules: {'trazabilidad_presupuestal', 'trazabilidad_organizacional'}
