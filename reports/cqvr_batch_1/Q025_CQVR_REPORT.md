...
```json
{
    ...
    "created_at": "2025-11-28T03:50:01.832224+00:00",
    "updated_at": "2025-12-16T04:42:57.439085+00:00"
}
```
...
|-------|----------|--------|-------|
| question_id | Q025 | Q025 | ✅ |
| policy_area_id | PA01 | PA01 | ✅ |
| dimension_id | DIM05 | DIM05 | ✅ |
| question_global | 25 | 25 | ✅ |
| base_slot | D5-Q5 | D5-Q5 | ✅ |
...
4. B3: Required elements not in validation rules: {'analisis_realismo', 'hipotesis_limite', 'efectos_no_deseados'}
