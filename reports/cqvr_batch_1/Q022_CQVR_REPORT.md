...
```json
{
    ...
    "created_at": "2025-11-28T03:50:01.821125+00:00",
    "updated_at": "2025-12-16T04:42:57.423651+00:00"
}
```
...
|-------|----------|--------|-------|
| question_id | Q022 | Q022 | ✅ |
| policy_area_id | PA01 | PA01 | ✅ |
| dimension_id | DIM05 | DIM05 | ✅ |
| question_global | 22 | 22 | ✅ |
| base_slot | D5-Q2 | D5-Q2 | ✅ |

#### A2. Alineación Method-Assembly (20 pts máx)

- **Métodos definidos**: 28
- **Reglas de ensamblaje**: 4
- **Namespaces provistos**: 28
...
1. A2: Low method usage ratio: 0.0% (0/28)
2. A4: source_hash is placeholder or missing
3. B2: No methodological_depth.methods defined
4. B3: Required elements not in validation rules: {'usa_proxies', 'justifica_validez', 'usa_indices_compuestos'}
