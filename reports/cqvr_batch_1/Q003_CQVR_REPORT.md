...
```json
{
    ...
    "created_at": "2025-11-28T03:49:29.787718+00:00",
    "updated_at": "2025-12-16T04:42:57.322405+00:00"
}
```
...
1. A2: Low method usage ratio: 0.0% (0/13)
2. A4: source_hash is placeholder or missing
3. B2: No methodological_depth.methods defined
4. B3: Required elements not in validation rules: {'asignacion_explicita', 'trazabilidad_ppi_bpin', 'suficiencia_justificada'}
