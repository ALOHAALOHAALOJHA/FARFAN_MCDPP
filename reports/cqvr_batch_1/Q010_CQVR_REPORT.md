...
```json
{
    ...
    "created_at": "2025-11-28T03:49:29.810814+00:00",
    "updated_at": "2025-12-16T04:42:57.357655+00:00"
}
```
...
|-------|----------|--------|-------|
| question_id | Q010 | Q010 | ✅ |
| policy_area_id | PA01 | PA01 | ✅ |
| dimension_id | DIM02 | DIM02 | ✅ |
| question_global | 10 | 10 | ✅ |
| base_slot | D2-Q5 | D2-Q5 | ✅ |
...
4. B3: Required elements not in validation rules: {'secuenciacion_logica', 'complementariedad_explicita'}
