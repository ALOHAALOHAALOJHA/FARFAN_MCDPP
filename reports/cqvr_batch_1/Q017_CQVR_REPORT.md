...
```json
{
    ...
    "updated_at": "2025-12-16T04:42:57.401651+00:00"
}
```
...
|-------|----------|--------|-------|
| question_id | Q017 | Q017 | ✅ |
| policy_area_id | PA01 | PA01 | ✅ |
| dimension_id | DIM04 | DIM04 | ✅ |
| question_global | 17 | 17 | ✅ |
| base_slot | D4-Q2 | D4-Q2 | ✅ |
...
4. B3: Required elements not in validation rules: {'condiciones_habilitantes', 'cadena_causal_explicita', 'supuestos_identificados'}
