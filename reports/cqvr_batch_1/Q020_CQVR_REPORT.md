...
```json
{
    ...
    "created_at": "2025-11-28T03:49:29.852066+00:00",
    "updated_at": "2025-12-16T04:42:57.414018+00:00"
}
```
...
|-------|----------|--------|-------|
| question_id | Q020 | Q020 | ✅ |
| policy_area_id | PA01 | PA01 | ✅ |
| dimension_id | DIM04 | DIM04 | ✅ |
| question_global | 20 | 20 | ✅ |
| base_slot | D4-Q5 | D4-Q5 | ✅ |
...
4. B3: Required elements not in validation rules: {'alineacion_ods', 'alineacion_pnd'}
