...
```json
{
    ...
    "created_at": "2025-11-28T03:50:01.826087+00:00",
    "updated_at": "2025-12-16T04:42:57.431283+00:00"
}
```
...
1. A2: Low method usage ratio: 0.0% (0/6)
2. A4: source_hash is placeholder or missing
3. B2: No methodological_depth.methods defined
4. B3: Required elements not in validation rules: {'proxy_para_intangibles', 'reconoce_limitaciones', 'documenta_validez'}
