...
```json
{
    ...
    "created_at": "2025-11-28T03:49:29.838805+00:00",
    "updated_at": "2025-12-16T04:42:57.395113+00:00"
}
```
...
|-------|----------|--------|-------|
| question_id | Q016 | Q016 | ✅ |
| policy_area_id | PA01 | PA01 | ✅ |
| dimension_id | DIM04 | DIM04 | ✅ |
| question_global | 16 | 16 | ✅ |
| base_slot | D4-Q1 | D4-Q1 | ✅ |

#### A2. Alineación Method-Assembly (20 pts máx)

- **Métodos definidos**: 16
- **Reglas de ensamblaje**: 4
- **Namespaces provistos**: 16
...
- **Patrones definidos**: 8
- **Elementos esperados**: 4
...
1. A2: Low method usage ratio: 6.2% (1/16)
2. A4: source_hash is placeholder or missing
3. B2: No methodological_depth.methods defined
4. B3: Required elements not in validation rules: {'linea_base_resultado', 'meta_resultado', 'horizonte_temporal', 'metrica_outcome'}
