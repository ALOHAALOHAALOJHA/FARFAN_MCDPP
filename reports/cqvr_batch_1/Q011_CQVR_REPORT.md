...
```json
{
    ...
    "created_at": "2025-11-28T03:49:29.814106+00:00",
    "updated_at": "2025-12-16T04:42:57.361827+00:00"
}
```
...
|-------|----------|--------|-------|
| question_id | Q011 | Q011 | ✅ |
| policy_area_id | PA01 | PA01 | ✅ |
| dimension_id | DIM03 | DIM03 | ✅ |
| question_global | 11 | 11 | ✅ |
| base_slot | D3-Q1 | D3-Q1 | ✅ |
...
1. A2: Low method usage ratio: 12.5% (1/8)
2. A4: source_hash is placeholder or missing
3. B2: No methodological_depth.methods defined
4. B3: Required elements not in validation rules: {'linea_base_producto', 'meta_cuantitativa', 'fuente_verificacion'}
