...
```json
{
    ...
    "created_at": "2025-11-28T03:50:01.816277+00:00",
    "updated_at": "2025-12-16T04:42:57.418123+00:00"
}
```
...
|-------|----------|--------|-------|
| question_id | Q021 | Q021 | ✅ |
| policy_area_id | PA01 | PA01 | ✅ |
| dimension_id | DIM05 | DIM05 | ✅ |
| question_global | 21 | 21 | ✅ |
| base_slot | D5-Q1 | D5-Q1 | ✅ |
...
4. B3: Required elements not in validation rules: {'impacto_definido', 'rezago_temporal', 'ruta_transmision'}
