...
```json
{
    ...
    "created_at": "2025-11-28T03:50:01.829220+00:00",
    "updated_at": "2025-12-16T04:42:57.435232+00:00"
}
```
...
|-------|----------|--------|-------|
| question_id | Q024 | Q024 | ✅ |
| policy_area_id | PA01 | PA01 | ✅ |
| dimension_id | DIM05 | DIM05 | ✅ |
| question_global | 24 | 24 | ✅ |
| base_slot | D5-Q4 | D5-Q4 | ✅ |
...
4. B3: Required elements not in validation rules: {'riesgos_sistemicos', 'alineacion_marcos'}
