...
This script audits all contracts in src/canonic_phases/Phase_two/json_files_phase_two/executor_contracts/specialized/
to ensure:
...
class ContractAuditor:
    ...
    def print_report(self) -> None:
        ...
        print(f"  - Multi-method pipeline: {stats.get('orchestration_mode_multi_method_pipeline', 0)}")
        ...
        print(f"\nSignal Irrigation:")
        print(f"  - Contracts with signal_requirements: {stats.get('contracts_with_signal_requirements', 0)}")
