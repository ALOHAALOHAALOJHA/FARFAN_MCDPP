...
El contrato Q042.v3.json alcanza 61.0/100 puntos.
...
- ✅ `question_id`: identity=Q042, schema=Q042 [5 pts]
- ✅ `policy_area_id`: identity=PA10, schema=PA10 [5 pts]
- ✅ `dimension_id`: identity=DIM03, schema=DIM03 [5 pts]
- ✅ `question_global`: identity=42, schema=42 [3 pts]
- ✅ `base_slot`: identity=D3-Q2, schema=D3-Q2 [2 pts]
...
**Evaluación**:
- Method count: 21 métodos declarados
- Provides declarations: 21 namespaces
...
### Warnings (7)
- ⚠️ A2: Low method usage ratio: 0.0% (0/21)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'dosificacion_definida', 'proporcionalidad_meta_problema'}
...
**Generado**: 2025-12-17T02:54:49.593859  
