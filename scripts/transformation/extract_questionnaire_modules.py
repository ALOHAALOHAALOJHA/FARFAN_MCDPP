...
class QuestionnaireModularizer:
    ...
    def load_monolith(self) -> None:
        ...
        print(f"Loaded {len(self.monolith.get('blocks', {}).get('micro_questions', []))} micro-questions")
    ...
    def save_dimension_files(self, dimension_questions: Dict[str, List[Dict]]) -> None:
        ...
        dim_info = self.monolith.get('blocks', {}).get('niveles_abstraccion', {}).get('dimensions', [])
    ...
    def save_policy_area_files(self, pa_questions: Dict[str, List[Dict]]) -> None:
        ...
        pa_definitions = self.monolith.get('blocks', {}).get('niveles_abstraccion', {}).get('policy_areas', [])
    ...
    def save_cluster_files(self, cluster_questions: Dict[str, List[Dict]]) -> None:
        ...
        cluster_definitions = self.monolith.get('blocks', {}).get('niveles_abstraccion', {}).get('clusters', [])
        ...
        for cluster_id, questions in cluster_questions.items():
            ...
            cluster_metadata = next((c for c in cluster_definitions if c.get('cluster_id') == cluster_id), {})
    ...
    def save_niveles_abstraccion(self) -> None:
        ...
        with open(niveles_file, 'w', encoding='utf-8') as f:
            json.dump(self.monolith.get('blocks', {}).get('niveles_abstraccion', {}), f, indent=2, ensure_ascii=False)
    ...
    def save_scoring_system(self) -> None:
        ...
        with open(scoring_file, 'w', encoding='utf-8') as f:
            json.dump(self.monolith.get('blocks', {}).get('scoring', {}), f, indent=2, ensure_ascii=False)
    ...
    def save_semantic_layers(self) -> None:
        ...
        with open(semantic_file, 'w', encoding='utf-8') as f:
            json.dump(self.monolith.get('blocks', {}).get('semantic_layers', {}), f, indent=2, ensure_ascii=False)
