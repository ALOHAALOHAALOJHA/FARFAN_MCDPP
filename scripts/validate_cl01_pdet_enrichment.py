...
def validate_pdet_enrichment(metadata: Dict[str, Any]) -> Dict[str, Any]:
    ...
    required_fields = [
        "relevance", "description", "territorial_scope",
        "institutional_actors", "financing_context",
        "territorial_disaggregation", "coherence_requirements"
    ]
    ...
    results["summary"]["municipalities"] = pdet_context.get("territorial_scope", {}).get("municipalities", 0)
    results["summary"]["subregions"] = pdet_context.get("territorial_scope", {}).get("subregions", 0)
