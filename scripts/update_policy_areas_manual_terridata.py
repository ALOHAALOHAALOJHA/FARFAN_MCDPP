...
class PolicyAreaUpdater:
    ...
    def update_policy_area(self, pa_key: str) -> bool:
        ...
        if pa_key in MANUAL_TERRIDATA_FIELD_MAPPING:
            ...
            pdet_enrich["pdet_context"]["manual_terridata_fields"] = MANUAL_TERRIDATA_FIELD_MAPPING[
                pa_key
            ]
        ...
        logger.info(
            f"Updated {pa_key} with {len(MANUAL_TERRIDATA_FIELD_MAPPING.get(pa_key, []))} TerriData field references"
        )
        return True
    ...
    def update_all_policy_areas(self) -> Dict[str, int]:
        ...
        stats = {"updated": 0, "failed": 0, "total_fields": 0}
