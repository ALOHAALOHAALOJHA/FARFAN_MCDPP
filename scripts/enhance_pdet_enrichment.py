...
ADDITIONAL_DATA_FIELDS = {
    "demographic": ["population", "rural_percentage", "ethnic_composition", "population_density"],
    "institutional": ["category", "fiscal_autonomy", "icld_smmlv", "institutional_capacity_index"],
    "pdet_specific": [
        "patr_initiatives",
...
def enhance_metadata_file(metadata_path: Path, enhanced_indicators: List[str]) -> None:
    ...
    pdet["_validation_gates"]["gate_2_value_add"]["enables"].extend(
        ["granular_analysis", "multi_indicator_validation", "comprehensive_monitoring"]
    )
