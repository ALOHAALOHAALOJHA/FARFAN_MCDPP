...
class ManualTerriDataEnricher:
    ...
    def _estimate_infrastructure_data(self, muni: Dict[str, Any]) -> Dict[str, Any]:
        ...
        category_factor = {
            'Special': 1.0, 'First': 0.95, 'Second': 0.85,
            'Third': 0.75, 'Fourth': 0.65, 'Fifth': 0.55, 'Sixth': 0.45
        }.get(category, 0.65)
...
def main():
    ...
    print(f"Municipalities enriched: {enriched_data['_manual_terridata_enrichment']['municipalities_enriched']}")
