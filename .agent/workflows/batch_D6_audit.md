---
description: Audit and correct batch D6 (Q1-Q5) contracts against episte_refact.md
---

# PROTOCOLO LOTE D6 (Dimensión 6)

## LOTE D6: Definición de Contratos y Tipos
```
| Contrato   | Question ID | Tipo Canónico | Estrategia Principal |
|------------|-------------|---------------|----------------------|
| D6-Q1-v4   | Q026        | TYPE_C        | topological_overlay |
| D6-Q2-v4   | Q027        | TYPE_B        | bayesian_update |
| D6-Q3-v4   | Q028        | TYPE_E        | logical_consistency_validation |
| D6-Q4-v4   | Q029        | TYPE_B        | bayesian_update |
| D6-Q5-v4   | Q030        | TYPE_C        | topological_overlay |
```
...
### Para cada contrato [D6-Q1, D6-Q2, D6-Q3, D6-Q4, D6-Q5]:
...
DEBE coincidir con tabla de LOTE D6 arriba.
```
