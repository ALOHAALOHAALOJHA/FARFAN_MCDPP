---
description: Audit and correct batch D2 (Q1-Q5) contracts against episte_refact.md
---

# PROTOCOLO LOTE D2 (Dimensión 2)

## LOTE D2: Definición de Contratos y Tipos
```
| Contrato   | Question ID | Tipo Canónico | Estrategia Principal |
|------------|-------------|---------------|----------------------|
| D2-Q1-v4   | Q006        | TYPE_D        | financial_coherence_audit |
| D2-Q2-v4   | Q007        | TYPE_B        | bayesian_update |
| D2-Q3-v4   | Q008        | TYPE_C        | topological_overlay |
| D2-Q4-v4   | Q009        | TYPE_D        | financial_coherence_audit |
| D2-Q5-v4   | Q010        | TYPE_E        | logical_consistency_validation |
```
...
### Para cada contrato [D2-Q1, D2-Q2, D2-Q3, D2-Q4, D2-Q5]:
...
DEBE coincidir con tabla de LOTE D2 arriba.
```
