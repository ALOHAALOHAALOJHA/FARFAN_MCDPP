...
- ✅ `question_id`: identity=Q169, schema=Q169
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM04, schema=DIM04
- ✅ `question_global`: identity=169, schema=169
- ✅ `base_slot`: identity=D4-Q4, schema=D4-Q4
...
- ⚠️ B3: Required elements not in validation rules: {'criterios_exito_definidos', 'vinculo_resultado_problema'}
...
El contrato Q169.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.894494  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
