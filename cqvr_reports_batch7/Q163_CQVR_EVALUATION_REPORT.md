...
- ✅ `question_id`: identity=Q163, schema=Q163
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM03, schema=DIM03
- ✅ `question_global`: identity=163, schema=163
- ✅ `base_slot`: identity=D3-Q3, schema=D3-Q3
...
- **Method count**: 22 (declared: 22)
- **Provides defined**: 22
- **Sources referenced**: 0
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 22

⚠️ **Many unused methods**: 22/22
...
- ⚠️ A2: Low method usage ratio: 0.0% (0/22)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'trazabilidad_organizacional', 'trazabilidad_presupuestal'}
...
El contrato Q163.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.889494  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
