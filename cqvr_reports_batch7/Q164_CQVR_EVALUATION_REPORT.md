...
- ✅ `question_id`: identity=Q164, schema=Q164
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM03, schema=DIM03
- ✅ `question_global`: identity=164, schema=164
- ✅ `base_slot`: identity=D3-Q4, schema=D3-Q4
...
- **Method count**: 26 (declared: 26)
- **Provides defined**: 26
- **Sources referenced**: 0
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 26

⚠️ **Many unused methods**: 26/26
...
- ⚠️ A2: Low method usage ratio: 0.0% (0/26)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'realismo_plazos', 'factibilidad_tecnica', 'coherencia_recursos'}
...
El contrato Q164.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.890483  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
