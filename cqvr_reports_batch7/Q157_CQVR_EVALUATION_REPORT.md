...
- ✅ `question_id`: identity=Q157, schema=Q157
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM02, schema=DIM02
- ✅ `question_global`: identity=157, schema=157
- ✅ `base_slot`: identity=D2-Q2, schema=D2-Q2
...
- ⚠️ B3: Required elements not in validation rules: {'logica_causal_explicita', 'poblacion_objetivo_definida', 'instrumento_especificado'}
...
El contrato Q157.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.884619  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
