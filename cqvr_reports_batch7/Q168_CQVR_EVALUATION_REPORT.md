...
- ✅ `question_id`: identity=Q168, schema=Q168
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM04, schema=DIM04
- ✅ `question_global`: identity=168, schema=168
- ✅ `base_slot`: identity=D4-Q3, schema=D4-Q3
...
- ⚠️ B3: Required elements not in validation rules: {'justificacion_recursos', 'evidencia_comparada', 'justificacion_capacidad'}
...
El contrato Q168.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.893780  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
