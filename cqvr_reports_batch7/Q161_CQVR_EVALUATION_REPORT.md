...
- ✅ `question_id`: identity=Q161, schema=Q161
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM03, schema=DIM03
- ✅ `question_global`: identity=161, schema=161
- ✅ `base_slot`: identity=D3-Q1, schema=D3-Q1
...
- ⚠️ B3: Required elements not in validation rules: {'meta_cuantitativa', 'fuente_verificacion', 'linea_base_producto'}
...
El contrato Q161.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.887580  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
