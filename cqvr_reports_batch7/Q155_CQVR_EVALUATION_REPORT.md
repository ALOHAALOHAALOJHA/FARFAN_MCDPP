...
- ✅ `question_id`: identity=Q155, schema=Q155
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM01, schema=DIM01
- ✅ `question_global`: identity=155, schema=155
- ✅ `base_slot`: identity=D1-Q5, schema=D1-Q5
...
- **Method count**: 7 (declared: 7)
- **Provides defined**: 7
- **Sources referenced**: 0
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 7

⚠️ **Many unused methods**: 7/7
...
- ⚠️ A2: Low method usage ratio: 0.0% (0/7)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'restricciones_competencias', 'coherencia_demostrada', 'restricciones_legales', 'restricciones_presupuestales'}
...
El contrato Q155.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.883031  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
