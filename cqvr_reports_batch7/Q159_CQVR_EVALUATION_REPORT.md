...
- ✅ `question_id`: identity=Q159, schema=Q159
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM02, schema=DIM02
- ✅ `question_global`: identity=159, schema=159
- ✅ `base_slot`: identity=D2-Q4, schema=D2-Q4
...
- **Method count**: 10 (declared: 10)
- **Provides defined**: 10
- **Sources referenced**: 0
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 10

⚠️ **Many unused methods**: 10/10
...
- ⚠️ B3: Required elements not in validation rules: {'mitigacion_propuesta', 'riesgos_identificados'}
...
El contrato Q159.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.886097  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
