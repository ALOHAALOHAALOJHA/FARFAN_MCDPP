...
- ✅ `question_id`: identity=Q154, schema=Q154
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM01, schema=DIM01
- ✅ `question_global`: identity=154, schema=154
- ✅ `base_slot`: identity=D1-Q4, schema=D1-Q4
...
- **Method count**: 11 (declared: 11)
- **Provides defined**: 11
- **Sources referenced**: 0
- **Orphan sources** (not in provides): 0
- **Unused methods** (not in sources): 11

⚠️ **Many unused methods**: 11/11
...
- ⚠️ A2: Low method usage ratio: 0.0% (0/11)
- ⚠️ A4: source_hash is placeholder or missing
- ⚠️ B2: No methodological_depth.methods defined
- ⚠️ B3: Required elements not in validation rules: {'procesos', 'infraestructura_fisica', 'talento_humano', 'cuellos_botella', 'gobernanza'}
...
El contrato Q154.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.881889  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
