...
- ✅ `question_id`: identity=Q175, schema=Q175
- ✅ `policy_area_id`: identity=PA05, schema=PA05
- ✅ `dimension_id`: identity=DIM05, schema=DIM05
- ✅ `question_global`: identity=175, schema=175
- ✅ `base_slot`: identity=D5-Q5, schema=D5-Q5
...
- ⚠️ B3: Required elements not in validation rules: {'hipotesis_limite', 'analisis_realismo', 'efectos_no_deseados'}
...
El contrato Q175.v3.json ha sido evaluado bajo la rúbrica CQVR v2.0:
...
**Generado**: 2025-12-17T09:28:12.899046  
**Evaluador**: CQVR Batch Evaluator v2.0  
**Rúbrica**: CQVR v2.0 (100 puntos)
