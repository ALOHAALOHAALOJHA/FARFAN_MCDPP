...
1. ⚠️ A2: Low method usage ratio: 0.0% (0/22)
2. ⚠️ A4: source_hash is placeholder or missing
3. ⚠️ B2: No methodological_depth.methods defined
4. ⚠️ B3: Required elements not in validation rules: {'trazabilidad_presupuestal', 'trazabilidad_organizacional'}
...
Timestamp: `2025-12-17T02:48:18.884343`  
