...
1. ⚠️ A2: Low method usage ratio: 0.0% (0/13)
2. ⚠️ A4: source_hash is placeholder or missing
3. ⚠️ B2: No methodological_depth.methods defined
4. ⚠️ B3: Required elements not in validation rules: {'asignacion_explicita', 'suficiencia_justificada', 'trazabilidad_ppi_bpin'}
...
Timestamp: `2025-12-17T02:48:18.878052`  
