...
class CQCLoader:
        ...
        if flat_view.exists():
            with open(flat_view) as f:
                ...
                return {
                    ...
                    "_from_view": True,
                    "blocks": {"micro_questions": data.get("questions", [])},
                }
    ...
    def _build_questionnaire_in_memory(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "blocks": {"micro_questions": questions},
        }
                    ...
                    if theme_folder.is_dir():
                        ...
                        if detection_file.exists():
                            with open(detection_file) as f:
                                self._cross_cutting_cache["themes"][theme_folder.name] = json.load(
                                    f
                                )
