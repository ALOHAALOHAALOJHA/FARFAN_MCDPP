...
class CQCBuilder:
    ...
    def _validate_referential_integrity(self) -> None:
        ...
        if self.errors:
            logger.warning(
                f"    Found {self.metrics.integrity_errors} errors, {self.metrics.warnings} warnings"
            )
        else:
    ...
    def _build_pattern_question_matrix(self) -> None:
        ...
        stats = {
            ...
            "questions_with_patterns": len(
                [q for q in inverse_index if inverse_index[q]["pattern_count"] > 0]
            ),
        }
    ...
    def _build_keyword_pa_matrix(self) -> None:
        ...
        output = {
            ...
            "statistics": {
                ...
                "avg_pas_per_keyword": (
                    round(sum(len(m["policy_areas"]) for m in matrix.values()) / len(matrix), 2)
                    if matrix
                    else 0
                ),
            },
    ...
    def _build_signal_flow_graph(self) -> None:
        ...
        for mc_id in self._membership_criteria.keys():
            edges.append({"source": mc_id, "target": "PHASE_1", "type": "PRODUCES"})
    ...
    def _build_monolith_legacy(self) -> None:
        ...
        monolith = {
            ...
            "blocks": {"micro_questions": micro_questions},
        }
    ...
    def _generate_build_manifest(self) -> None:
        ...
        manifest = {
            ...
            "legacy_artifacts": ["questionnaire_monolith.json"],
            "success": self.metrics.integrity_errors == 0,
        }
