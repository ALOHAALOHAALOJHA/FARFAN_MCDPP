...
class GateConfig:
    ...
    gate_2_value_add: ValidatorConfig = field(default_factory=lambda: ValidatorConfig(threshold=0.10))
...
class ConfigurationManager:
    ...
    def _dict_to_config(self, data: Dict[str, Any]) -> EnrichmentConfig:
        ...
        gates = GateConfig(
            ...
            gate_2_value_add=ValidatorConfig(**gates_data.get("gate_2_value_add", {"threshold": 0.10})),
    ...
    def validate_config(self) -> List[str]:
        ...
        if self._config.connection_pool_size <= 0:
            errors.append(f"connection_pool_size must be positive, got {self._config.connection_pool_size}")
