...
class BaseValidator(ABC):
    ...
    def __init__(
        self, name: str, version: str = "1.0.0", enabled: bool = True, strict_mode: bool = True
    ):
        self._name = name
...
class ValidatorRegistry:
    ...
    def register(self, validator: ValidatorProtocol, priority: Optional[int] = None) -> None:
        """
    ...
    def get_all(self) -> List[ValidatorProtocol]:
        ...
        return [
            self._validators[name] for name in self._validator_order if name in self._validators
        ]
    ...
    def validate_all(
        self, context: Dict[str, Any], stop_on_first_failure: bool = False
