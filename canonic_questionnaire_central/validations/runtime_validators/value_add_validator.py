...
class ValueAddScorer:
    ...
    def record_enriched(
        self, question_id: str, score: float, contributing_signals: List[str]
    ) -> None:
    ...
    def should_emit(
        self, signal_type: str, payload: Dict[str, Any], threshold: Optional[float] = None
    ) -> bool:
