...
PREDEFINED_SCOPES = {
    ScopeLevel.EVIDENCE_COLLECTION: SignalScope(
        ...
        allowed_signal_types=[
            ...
            "PROGRAMMATIC_HIERARCHY", "FINANCIAL_CHAIN", "TEMPORAL_MARKER",
            "CAUSAL_LINK", "INSTITUTIONAL_ENTITY", "SEMANTIC_RELATIONSHIP"
        ],
        min_confidence=0.50, max_signals_per_query=200
    ),
    ScopeLevel.SCORING_BASELINE: SignalScope(
        ...
        min_confidence=0.70, max_signals_per_query=50
    ),
    ScopeLevel.SCORING_QUALITY: SignalScope(
        ...
        min_confidence=0.65, max_signals_per_query=75
    ),
    ScopeLevel.SCORING_CHAIN: SignalScope(
        ...
        min_confidence=0.60, max_signals_per_query=100
    ),
    ScopeLevel.CROSS_CUTTING: SignalScope(
        scope_name="Cross-Cutting Themes",
        scope_level=ScopeLevel.CROSS_CUTTING,
        allowed_signal_types=["CROSS_CUTTING_THEME", "POPULATION_DISAGGREGATION", "INSTITUTIONAL_ENTITY"],
        min_confidence=0.55, max_signals_per_query=50
    ),
}
