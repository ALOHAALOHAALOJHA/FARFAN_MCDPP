...
class AuditTrail:
    ...
    def __init__(
        self, trail_id: str, max_memory_entries: int = 1000, persist_path: Optional[Path] = None
    ):
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        if not self._entries:
            return {"total_entries": 0, "success_rate": 0.0, "avg_execution_time": 0.0}
...
class AuditTrailManager:
    ...
    def get_or_create_trail(self, trail_id: str, max_memory_entries: int = 1000) -> AuditTrail:
        ...
        trail = AuditTrail(
            trail_id=trail_id, max_memory_entries=max_memory_entries, persist_path=persist_path
        )
