...
class TestSISASGoldenPath:
    ...
    def test_quantitative_triplet_extractor(self, sample_text: str):
        ...
        from src.farfan_pipeline.infrastructure.extractors import QuantitativeTripletExtractor
    ...
    def test_normative_reference_extractor(self, sample_text: str):
        ...
        from src.farfan_pipeline.infrastructure.extractors import NormativeReferenceExtractor
    ...
    def test_signal_enricher_extract_and_route(self, sample_text: str):
        ...
        from src.farfan_pipeline.phases.Phase_one.phase1_60_00_signal_enrichment import SignalEnricher
    ...
    def test_signal_enriched_scorer_adjustments(self):
        ...
        from src.farfan_pipeline.phases.Phase_three.phase3_signal_enriched_scoring import SignalEnrichedScorer
