...
def test_jf0_resolver_implementation():
    ...
    required_prov = {
        'assembly_timestamp', 'resolver_version', 'source_file_count',
        'source_paths', 'assembly_duration_ms'
    }
    ...
    if CanonicalQuestionnaireResolver.EXPECTED_QUESTION_COUNT != 300:
        raise AssertionError(f'EXPECTED_QUESTION_COUNT is {CanonicalQuestionnaireResolver.EXPECTED_QUESTION_COUNT}, expected 300')
    print('PASS')
...
def test_jf2_sisas_provenance():
    ...
    sisas_path = Path('src/farfan_pipeline/infrastructure/irrigation_using_signals/SISAS/signal_registry.py')
...
def run_all_tests():
    ...
    try:
        ...
        print('  ✓ src/farfan_pipeline/infrastructure/irrigation_using_signals/SISAS/signal_registry.py')
