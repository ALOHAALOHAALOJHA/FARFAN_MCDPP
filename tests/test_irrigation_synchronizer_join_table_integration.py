...
def test_irrigation_synchronizer_imports():
    ...
    from farfan_pipeline.phases.Phase_02.irrigation_synchronizer import (
...
def test_irrigation_synchronizer_with_join_table_disabled():
    ...
    from farfan_pipeline.phases.Phase_02.irrigation_synchronizer import IrrigationSynchronizer
