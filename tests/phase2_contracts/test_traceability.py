...
class TestTraceabilityContract:
    ...
    def test_tc_005_tampered_step_fails(self, execution_steps: list[str]) -> None:
        ...
        assert not TraceabilityContract.verify_trace(tampered_steps, tree_original.root)

    def test_tc_006_order_matters(self, execution_steps: list[str]) -> None:
    ...
    def test_tc_010_merkle_leaves_correct(self, execution_steps: list[str]) -> None:
