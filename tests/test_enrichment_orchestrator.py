...
class TestEnrichmentOrchestrator:
    ...
    def test_enrichment_with_unauthorized_policy_area_fails_gate_1(self, orchestrator, valid_capabilities):
    ...
    def test_enrichment_with_missing_capabilities_fails_gate_3(self, orchestrator, valid_scope):
        ...
        assert any("capability" in v.lower() or "capabilities" in v.lower() for v in result.violations)
    ...
    def test_enrichment_with_partial_context_request(self, orchestrator, valid_scope, valid_capabilities):
    ...
    def test_enrichment_with_statistics_context(self, orchestrator, valid_scope, valid_capabilities):
