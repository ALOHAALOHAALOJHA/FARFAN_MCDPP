...
class TestCarverV3DataStructures:
    ...
    def test_method_epistemology_frozen(self):
        ...
        from farfan_pipeline.phases.Phase_two.carver import MethodEpistemology
    ...
    def test_technical_approach_frozen(self):
        ...
        from farfan_pipeline.phases.Phase_two.carver import TechnicalApproach
    ...
    def test_output_interpretation_frozen(self):
        ...
        from farfan_pipeline.phases.Phase_two.carver import OutputInterpretation
    ...
    def test_method_depth_entry_complete(self):
        ...
        from farfan_pipeline.phases.Phase_two.carver import (
            MethodDepthEntry, MethodEpistemology, TechnicalApproach, OutputInterpretation
        )
    ...
    def test_methodological_depth_structure(self):
        ...
        from farfan_pipeline.phases.Phase_two.carver import (
            MethodologicalDepth, MethodCombinationLogic
        )
...
class TestContractInterpreterV3:
    ...
    def test_extract_methodological_depth_from_v3_contract(self):
        ...
        from farfan_pipeline.phases.Phase_two.carver import ContractInterpreter
        ...
        assert result.methods[0].output_interpretation.actionable_insights == ["insight1", "insight2"]
...
class TestCarverRendererV3:
    ...
    def test_render_limitations_section(self):
        ...
        from farfan_pipeline.phases.Phase_two.carver import (
            CarverRenderer, MethodologicalDepth, MethodDepthEntry,
            MethodEpistemology, TechnicalApproach, OutputInterpretation
        )
        
        epi = MethodEpistemology(
            paradigm="test", ontological_basis="test",
            epistemological_stance="test", theoretical_framework=[],
            justification="test"
        )
        
        tech1 = TechnicalApproach(
            method_type="test", algorithm="test", steps=[],
            assumptions=[], limitations=["Cannot detect implicit causality", "Limited to single sentences"],
            complexity="O(n)"
        )
        
        tech2 = TechnicalApproach(
            method_type="test", algorithm="test", steps=[],
            assumptions=[], limitations=["Requires large context window", "May miss nuances"],
            complexity="O(n)"
        )
        ...
        method1 = MethodDepthEntry(
            method_name="m1", class_name="C1", priority=1, role="r1",
            epistemology=epi, technical_approach=tech1, output_interpretation=output
        )
        
        method2 = MethodDepthEntry(
            method_name="m2", class_name="C2", priority=2, role="r2",
            epistemology=epi, technical_approach=tech2, output_interpretation=output
        )
    ...
    def test_render_theoretical_references(self):
        ...
        tech = TechnicalApproach(
            method_type="test", algorithm="test", steps=[],
            assumptions=[], limitations=[], complexity="O(1)"
        )
        ...
        method1 = MethodDepthEntry(
            method_name="m1", class_name="C1", priority=1, role="r1",
            epistemology=epi1, technical_approach=tech, output_interpretation=output
        )
        
        method2 = MethodDepthEntry(
            method_name="m2", class_name="C2", priority=2, role="r2",
            epistemology=epi2, technical_approach=tech, output_interpretation=output
        )
    ...
    def test_render_actionable_insights(self):
        ...
        method1 = MethodDepthEntry(
            method_name="m1", class_name="C1", priority=1, role="r1",
            epistemology=epi, technical_approach=tech, output_interpretation=output1
        )
        
        method2 = MethodDepthEntry(
            method_name="m2", class_name="C2", priority=2, role="r2",
            epistemology=epi, technical_approach=tech, output_interpretation=output2
        )
...
class TestCarverAnswerV3:
    ...
    def test_carver_answer_backward_compatible(self):
        ...
        from farfan_pipeline.phases.Phase_two.carver import (
            CarverAnswer, Dimension, BayesianConfidenceResult
        )
    ...
    def test_carver_answer_with_v3_fields(self):
        ...
        from farfan_pipeline.phases.Phase_two.carver import (
            CarverAnswer, Dimension, BayesianConfidenceResult, MethodologicalDepth
        )
