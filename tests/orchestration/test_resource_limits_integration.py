...
class TestResourceLimitsStressIntegration:
    ...
    async def test_orchestrator_throttles_in_dev_mode(self) -> None:
        ...
        # Create orchestrator with tight limits
        resource_limits = ResourceLimits(
            max_memory_mb=100.0, max_cpu_percent=85.0, max_workers=4, min_workers=1
        )
    ...
    async def test_budget_reduction_logged(self) -> None:
        ...
        resource_limits = ResourceLimits(
            max_memory_mb=100.0, max_cpu_percent=85.0, max_workers=32, min_workers=4
        )
    ...
    async def test_phase2_enforces_limits_during_execution(self) -> None:
        ...
        # Mock executor class
        with patch.dict(orchestrator.executors, {"D1-Q1": SimulatedStressExecutor}):
            ...
            with patch.object(
                ...
                results = await orchestrator._execute_micro_questions_async(mock_document, config)
