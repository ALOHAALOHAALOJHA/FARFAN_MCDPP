...
def sample_questionnaire_hash(sample_questionnaire_data):
    ...
    json_str = json.dumps(
        sample_questionnaire_data, sort_keys=True, ensure_ascii=False, separators=(",", ":")
    )
...
def mock_method_executor_healthy():
    ...
    instances.get = Mock(
        side_effect=lambda name: (
            Mock()
            if name in ["PDFChunkExtractor", "SemanticAnalyzer", "DimensionAggregator"]
            else None
        )
    )
...
class TestQuestionnaireIntegrityGate:
    ...
    def test_questionnaire_integrity_pass_with_matching_hash(
        self, sample_questionnaire_hash, mock_runtime_config_prod
    ):
    ...
    def test_questionnaire_integrity_fail_with_mismatch(
        self, sample_questionnaire_hash, mock_runtime_config_prod
    ):
    ...
    def test_questionnaire_integrity_fail_without_computed_hash(
        self, sample_questionnaire_hash, mock_runtime_config_prod
    ):
...
class TestMethodRegistryGate:
    ...
    def test_method_registry_pass_with_expected_count(
        self, mock_runtime_config_prod, mock_method_executor_healthy
    ):
    ...
    def test_method_registry_fail_with_insufficient_count(
        self, mock_runtime_config_prod, mock_method_executor_insufficient
    ):
    ...
    def test_method_registry_fail_in_prod_with_failures(
        self, mock_runtime_config_prod, mock_method_executor_degraded
    ):
    ...
    def test_method_registry_pass_in_dev_with_failures(
        self, mock_runtime_config_dev, mock_method_executor_degraded
    ):
...
class TestSmokeTestsGate:
    ...
    def test_smoke_tests_pass_with_all_methods_available(
        self, mock_runtime_config_prod, mock_method_executor_healthy
    ):
    ...
    def test_smoke_tests_fail_in_prod_with_missing_methods(
        self, mock_runtime_config_prod, mock_method_executor_degraded
    ):
    ...
    def test_smoke_tests_pass_in_dev_with_missing_methods(
        self, mock_runtime_config_dev, mock_method_executor_degraded
    ):
...
class TestAllGatesIntegration:
    ...
    def test_all_gates_pass_with_full_validation(
        self, sample_questionnaire_hash, mock_runtime_config_prod, mock_method_executor_healthy
    ):
...
class TestMachineReadableErrors:
    ...
    def test_all_gates_results_serializable(
        self, sample_questionnaire_hash, mock_runtime_config_prod, mock_method_executor_insufficient
    ):
