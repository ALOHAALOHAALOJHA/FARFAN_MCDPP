...
class TestQuestionAwareArchitecture:
    ...
    def questionnaire_map(self, questionnaire_path: Path):
        ...
        from farfan_pipeline.phases.Phase_one.phase1_15_00_questionnaire_mapper import load_questionnaire_map
    ...
    def test_sp4_question_aware_signature(self):
        ...
        import inspect
        from farfan_pipeline.phases.Phase_one.phase1_25_00_sp4_question_aware import execute_sp4_question_aware
    ...
    def test_parse_question_id(self):
        ...
        from farfan_pipeline.phases.Phase_one.phase1_15_00_questionnaire_mapper import parse_question_id
    ...
    def test_create_chunk_id_for_question(self):
        ...
        from farfan_pipeline.phases.Phase_one.phase1_15_00_questionnaire_mapper import create_chunk_id_for_question
