...
class TestCL03ContextualEnrichment:
    ...
    def test_end_to_end_validation(self, enrichment_data):
        ...
        scope = SignalScope(
            ...
            scope_level=ScopeLevel.EVIDENCE_COLLECTION,
            allowed_signal_types=enrichment_data["_validation_gates_compliance"]["gate_1_scope"][
                "allowed_signal_types"
            ],
            allowed_policy_areas=enrichment_data["_validation_gates_compliance"]["gate_1_scope"][
        ...
        estimated_value = enrichment_data["_validation_gates_compliance"]["gate_2_value_add"][
            "estimated_value_add"
        ]
