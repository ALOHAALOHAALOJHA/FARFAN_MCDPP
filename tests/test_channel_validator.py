...
class TestChannelValidator:
    ...
    def test_check_flow_integrity_with_source_mismatch(self):
        ...
        payload = {"source": "wrong_source", "destination": "expected_dest", "data": {}}  # Mismatch
    ...
    def test_payload_schema_validation(self):
        ...
        valid_payload = {"source": "source", "timestamp": datetime.now().isoformat(), "data": {}}
        ...
        invalid_payload = {"source": "source", "data": {}}
...
class TestDataFlow:
    ...
    def test_data_flow_with_metadata(self):
        ...
        metadata = {"owner": "team_name", "version": "1.0.0", "tags": ["production", "critical"]}
...
class TestFlowManifest:
    ...
    def test_flow_manifest_creation(self):
        ...
        manifest = FlowManifest(
            manifest_version="1.0.0", generated_at="2024-01-01T00:00:00Z", flows=flows
        )
