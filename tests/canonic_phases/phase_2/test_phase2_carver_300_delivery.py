...
from src.canonic_phases.phase_2.phase2_b_carver import (
    Carver,
    CPPChunk,
    MicroAnswer,
    CarverError,
...
class TestCardinalityContract:
    ...
    def test_exact_60_chunks_produces_300_answers(self, carver: Carver, valid_chunks: List[CPPChunk]) -> None:
...
class TestProvenanceContract:
    ...
    def test_every_answer_traces_to_chunk(self, carver: Carver, valid_chunks: List[CPPChunk]) -> None:
    ...
    def test_provenance_metadata_preserved(self, carver: Carver, valid_chunks: List[CPPChunk]) -> None:
...
class TestShardingContract:
    ...
    def test_shard_indices_are_sequential(self, carver: Carver, valid_chunks: List[CPPChunk]) -> None:
