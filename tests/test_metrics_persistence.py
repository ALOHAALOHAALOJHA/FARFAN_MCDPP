...
def sample_phase_metrics() -> dict[str, Any]:
    ...
    return {
        "0": {
            ...
            "errors": [],
            "resource_snapshots": [],
            "latency_histogram": {"p50": 120.0, "p95": 123.0, "p99": 123.45},
            "anomalies": [],
        },
        "1": {
            "phase_id": 1,
            ...
            "errors": [],
            "resource_snapshots": [],
            "latency_histogram": {"p50": 450.0, "p95": 455.0, "p99": 456.78},
            "anomalies": [],
        },
    }
...
def sample_full_metrics(
    sample_phase_metrics: dict[str, Any], sample_resource_usage: list[dict[str, float]]
) -> dict[str, Any]:
...
def test_persist_phase_metrics_custom_filename(
    tmp_path: Path, sample_phase_metrics: dict[str, Any]
) -> None:
...
def test_persist_resource_usage(
    tmp_path: Path, sample_resource_usage: list[dict[str, float]]
) -> None:
...
@pytest.mark.updated
def test_persist_latency_histograms(tmp_path: Path, sample_phase_metrics: dict[str, Any]) -> None:
...
def test_persist_all_metrics_creates_directory(
    tmp_path: Path, sample_full_metrics: dict[str, Any]
) -> None:
...
def test_validate_metrics_schema_missing_keys() -> None:
    ...
    invalid_metrics = {"timestamp": "2024-01-01T00:00:00.000000", "phase_metrics": {}}
...
def test_validate_metrics_schema_missing_phase_keys() -> None:
    ...
    invalid_metrics = {
        "timestamp": "2024-01-01T00:00:00.000000",
        "phase_metrics": {"0": {"phase_id": 0, "name": "Test"}},
        "resource_usage": [],
        "abort_status": {},
        "phase_status": {},
    }
