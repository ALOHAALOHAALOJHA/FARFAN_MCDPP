...
class TestValidateMicroResultsInput:
    ...
    def test_validate_correct_count(self):
        ...
        micro_results = [
            MockMicroQuestionRun(f"Q{i:03d}", i, "SLOT", {}, {}) for i in range(1, 306)
        ]
    ...
    def test_validate_wrong_count_fails(self):
        ...
        micro_results = [
            MockMicroQuestionRun(f"Q{i:03d}", i, "SLOT", {}, {}) for i in range(1, 101)
        ]
    ...
    def test_validate_too_many_fails(self):
        ...
        micro_results = [
            MockMicroQuestionRun(f"Q{i:03d}", i, "SLOT", {}, {}) for i in range(1, 311)
        ]
