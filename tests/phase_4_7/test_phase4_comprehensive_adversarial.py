...
class TestAreaPolicyAggregatorAdversarial:
    ...
    def test_area_aggregation_with_all_dimensions(self, questionnaire_monolith):
        ...
        area_score = area_aggregator.aggregate_area(
            dimension_scores,
            {"policy_area": "PA01", "area_name": "Test Area"}
        )
...
class TestClusterAggregatorAdversarial:
    ...
    def test_cluster_aggregation_with_multiple_areas(self, questionnaire_monolith):
        ...
        cluster_score = cluster_aggregator.aggregate_cluster(
            area_scores,
            {"cluster_id": "MESO_1", "cluster_name": "Test Cluster"}
        )
    ...
    def test_cluster_aggregation_single_area(self):
        ...
        cluster_score = cluster_aggregator.aggregate_cluster(
            area_scores,
            {"cluster_id": "MESO_1", "cluster_name": "Single Area Cluster"}
        )
...
class TestMacroAggregatorAdversarial:
    ...
    def test_macro_aggregation_comprehensive(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.aggregation import (
            MacroAggregator, DimensionScore, AreaScore, ClusterScore
        )
    ...
    def test_macro_aggregation_identifies_gaps(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.aggregation import (
            MacroAggregator, DimensionScore
        )
...
class TestChoquetAggregatorAdversarial:
    ...
    def test_choquet_boundedness_violation(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.choquet_aggregator import (
            ChoquetAggregator, ChoquetConfig, CalibrationConfigError
        )
...
class TestProvenanceDAGAdversarial:
    ...
    def test_dag_cycle_detection(self):
        ...
        dag.add_node(ProvenanceNode(node_id="B", level="dimension", score=2.0, quality_level="BUENO"))
    ...
    def test_dag_lineage_tracing(self):
        ...
        dag.add_aggregation_edge(["Q001", "Q002", "Q003"], "DIM01", "weighted_average", [1/3, 1/3, 1/3])
    ...
    def test_shapley_attribution(self):
        ...
        dag.add_node(ProvenanceNode(node_id="Q001", level="micro", score=1.0, quality_level="ACEPTABLE"))
        dag.add_node(ProvenanceNode(node_id="Q002", level="micro", score=3.0, quality_level="EXCELENTE"))
        dag.add_node(ProvenanceNode(node_id="DIM01", level="dimension", score=2.0, quality_level="BUENO"))
    ...
    def test_critical_path_identification(self):
        ...
        dag.add_node(ProvenanceNode(node_id="Q001", level="micro", score=0.5, quality_level="INSUFICIENTE"))
        dag.add_node(ProvenanceNode(node_id="Q002", level="micro", score=2.5, quality_level="EXCELENTE"))
        dag.add_node(ProvenanceNode(node_id="Q003", level="micro", score=2.0, quality_level="BUENO"))
        dag.add_node(ProvenanceNode(node_id="DIM01", level="dimension", score=1.67, quality_level="BUENO"))
...
class TestAggregationIntegrationAdversarial:
    ...
    def test_aggregate_policy_areas_async(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.aggregation_integration import (
            aggregate_policy_areas_async, DimensionScore
        )
    ...
    def test_evaluate_macro_integration(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.aggregation_integration import (
            evaluate_macro, DimensionScore, AreaScore, ClusterScore
        )
...
class TestPhase4EndToEndFlow:
    ...
    def test_full_flow_phase3_to_phase5(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.aggregation_integration import (
            aggregate_dimensions_async, aggregate_policy_areas_async
        )
        ...
        for dim_idx in range(1, 7):
            for q_idx in range(1, 6):
                phase3_output.append(ScoredResult(
...
class TestPhase4ConstantsAdversarial:
    ...
    def test_quality_level_constants(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.PHASE_4_7_CONSTANTS import (
...
class TestPhase4ValidationAdversarial:
    ...
    def test_area_score_validation_hermeticity(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.validation.phase4_7_validation import (
            validate_area_score_hermeticity, AreaScore, DimensionScore
        )
...
class TestEnhancedAggregatorsAdversarial:
    ...
    def test_enhanced_dimension_aggregator(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.enhancements.enhanced_aggregators import (
    ...
    def test_enhanced_area_aggregator(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.enhancements.enhanced_aggregators import (
            EnhancedAreaAggregator, DimensionScore
        )
...
class TestChoquetPrimitivesAdversarial:
    ...
    def test_fuzzy_measure_operations(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.primitives.choquet_primitives import (
            FuzzyMeasure, is_fuzzy_measure, check_monotonicity
        )
...
class TestSignalEnrichedAggregationAdversarial:
    ...
    def test_signal_enriched_aggregator(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.signal_enriched_aggregation import (
    ...
    def test_critical_score_detection(self):
        ...
        critical = detect_critical_scores(
            scores,
            threshold=0.5,
            boost_factor=1.2
        )
...
class TestAdaptiveMesoScoringAdversarial:
    ...
    def test_adaptive_method_selection(self):
        ...
        method1 = scorer.select_aggregation_method(
            scores=[0.5, 2.5, 1.0, 3.0, 0.8],
            context={"variance_threshold": 0.5}
        )

        # Low variance: should choose standard method
        method2 = scorer.select_aggregation_method(
            scores=[2.0, 2.1, 1.9, 2.0, 2.0],
            context={"variance_threshold": 0.5}
        )
    ...
    def test_performance_tracking(self):
        ...
        from farfan_pipeline.phases.Phase_four_five_six_seven.adaptive_meso_scoring import (
            AdaptiveMesoScoring, ScoringMetrics
        )
