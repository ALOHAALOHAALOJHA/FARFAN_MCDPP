...
''')
    ...
    def test_missing_label_detected(self, tmp_path: Path) -> None:
        ...
        test_file.write_text('''"""Module docstring without Phase 2 label.
...
class TestVerificationReport:
    ...
    def test_report_with_compliant_files(self, tmp_path: Path) -> None:
        ...
        for i in range(3):
            ...
            file.write_text(f'''"""Module {i} docstring.
...
''')
    ...
    def test_report_with_violations(self, tmp_path: Path) -> None:
        ...
        compliant.write_text('''"""Compliant module.
...
''')
        ...
        violated.write_text('''"""No label here.
"""
''')
    ...
    def test_fail_fast_termination(self, tmp_path: Path) -> None:
        ...
        for i in range(10):
            ...
            file.write_text(f'''"""Module {i} without label.
"""
''')
