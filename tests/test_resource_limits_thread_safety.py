...
from farfan_pipeline.resilience import CircuitBreaker, CircuitBreakerConfig, CircuitBreakerOpen, CircuitState
...
class TestCircuitBreaker:
    ...
    def test_circuit_breaker_open_exception(self):
        ...
        if not cb.can_execute():
            time_until_retry = cb.config.timeout_seconds - (
                time.monotonic() - cb.last_failure_time
            )
